...
Use `admin@skillsprint.local` / `ChangeMe123!` locally only. Replace or disable those seeded accounts before deployment. API documentation is at `http://127.0.0.1:8000/docs`.
